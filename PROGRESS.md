...
| 工具箱模块 | 已实现（日历/番茄钟/迷信指数/赛博许愿池） |
| 游戏模块 | 已实现（2048 起风了版，水豚图片 tile） |
...
| 工具箱页 `/tools` | 完成 | 瀑布流双列：实时日历、番茄钟、今日迷信指数、赛博许愿池 |
| 游戏区页 `/games` | 完成 | 游戏大厅卡片列表 |
| 2048 起风了版 | 完成 | 博客标签主题，18 张水豚 AI 插画 tile，键盘/触摸/移动端支持 |
